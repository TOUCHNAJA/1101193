...
<p align ="right" style="color:white;">
    <?php
        $usernamecok = $_COOKIE['usercok'];
        echo "User : " . $usernamecok;
    ?>
    <form name="logouter" method="get" action="logmeout.php" align ="right">
...
<header class="wrap">
            ...
            <div id="gameover">
                <h2>Game Over</h2>
                <p>press <span style="background-color: #ffffff; color: #000000">space</span> to begin a newgame</p>
...
<script type="text/javascript">
  ...
  <noscript>
      <link data-avlabs-exclude-css="1"  rel="stylesheet" href="https://fonts.googleapis.com/css?family=PT%20Sans%7CLato%3A400%2C700%2C400italic%2C700italic%7COswald%3A400%2C700&display=swap" />
      <link data-avlabs-exclude-css="1"  rel="stylesheet" href="https://www.html5canvastutorials.com/wp-content/cache/min/1/ab18f1b535c8d0122f2764ebbf10fcb0.css" media="all" data-minify="1" />
